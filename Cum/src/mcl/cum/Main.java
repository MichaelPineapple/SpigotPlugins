...
public class Main extends JavaPlugin implements Listener
{
    ...
    PotionEffect cumEffect = new PotionEffect(PotionEffectType.SLOWNESS, 500, 0);
    PotionEffect godcumEffect1 = new PotionEffect(PotionEffectType.LEVITATION, 100, 1);
    PotionEffect godcumEffect2 = new PotionEffect(PotionEffectType.NAUSEA, 100, 1);
    ...
    {
        String item = event.getItem().getItemMeta().getItemName();
        ...
        if (item.equals(GODCUM_ID))
        {
            ...
            player.addPotionEffect(godcumEffect1);
            player.addPotionEffect(godcumEffect2);
        ...
        public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args)
        {
            ...
            if (sender instanceof Player)
            {
                ...
                if (chimken > 0 || player.getGameMode() == GameMode.CREATIVE || player.getGameMode() == GameMode.SPECTATOR)
                {
                    ...
                    player.addPotionEffect(cumEffect);
                ...
                else
                {
                    ...
                    player.sendMessage("You must eat before nutting again.");
                }
            }
            else
            {
